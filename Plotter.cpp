...
void Plotter::Plot()
{
    ...
    {
        Serial.print(",\"");
        Serial.print(NUM_GRAPH_KEY);
        Serial.print("\":");
        Serial.print(numGraphs);
        Serial.print(",\"");
        Serial.print(LAST_UPDATED_KEY);
        Serial.print("\":");
...
Plotter::Graph::Graph(const char *title, VariableWrapper *wrappers, int size, bool xvy, int pointsDisplayed) : next(NULL),
                                                                                                               xvy(xvy),
                                                                                                               size(size),
...
void Plotter::Graph::Plot(bool config)
{
    ...
    {
        Serial.print("\"");
        Serial.print(TITLE_KEY);
        Serial.print("\":");
        Serial.print("\"");
        Serial.print(title);
        Serial.print("\"");
        Serial.print(",\"");
        Serial.print(XVY_KEY);
        Serial.print("\":");
        Serial.print(xvy);
        Serial.print(",\"");
        Serial.print(POINTS_DISPLAYED_KEY);
        Serial.print("\":");
        Serial.print(pointsDisplayed);
        Serial.print(",\"");
        Serial.print(SIZE_KEY);
        Serial.print("\":");
        Serial.print(size);
        Serial.print(",\"");
...
Plotter::VariableWrapper::VariableWrapper() : ref(NULL),
                                              deref(NULL)
{
}

Plotter::VariableWrapper::VariableWrapper(const char *label, void *ref, double (*deref)(void *), const char *color) : label(label),
                                                                                                                      color(color),
                                                                                                                      ref(ref),
                                                                                                                      deref(deref)
{
